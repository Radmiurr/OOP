...
public class Main {
    public static void main(String[] args) {
        ...
        SentenceLenComparisonWithNumber instanceMain = SentenceLenComparisonWithNumber.getInstance();
        instanceMain.setMinSentenceLength(2);

        // Создание второго экземпляра без установки minSentenceLength
        SentenceLenComparisonWithNumber instanceSecond = SentenceLenComparisonWithNumber.getInstance();

        System.out.println("Введите текст: ");
        String inputText = scanner.nextLine();

        ArrayList<String> result =  instanceMain.sentenceLenComparisonWithNumber(inputText);
                    if (result.size() != 0){
                        ...
                        System.out.println(instanceMain.getMinSentenceLength());
                    }
        System.out.println(instanceSecond.getMinSentenceLength());
    }
}
